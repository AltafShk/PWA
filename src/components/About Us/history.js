    ...
    return (
          <React.Fragment>
            ...
            <Container className="hist-main mt-3">
                <p className="col-12 mb-3" style={{textAlign: "justify"}}>
            ...
            <Container className="mt-3">
                <Row>
                    ...
                    <Col xs='10' className="hist-main" style={{lineHeight: 1.8}}>
                        <p >For nearly 4 decades, Patients’ Welfare Association has striven to serve the destitute entering Dr. Ruth K.M. Pfau Civil Hospital with dedication and professionalism. All the data shown below is a living testament to that fact.</p>
                        <ul>
                            <li>Our blood bank has provided 1.4 million blood products to the masses.</li>
                            <li>PWA Drugbank has disbursed medicines and injections worth over PKR 92 million to the needy, benefiting roughly 8000-10,000 patients each year, all free of cost.</li>
                            <li>PWA Thalassemia Daycare Center has spent over PKR 52 million on treatments such iron chelation therapy. This costs stands apart from the cost of providing regular screened blood transfusions which often exceed 7500 in number each year.</li>
                            <li>PWA has spent over PKR 704 million on the welfare of others and with the continued support of our kind donors and well-wishers, we hope to serve a lot more.</li>
                        </ul>
                    </Col>
                    <Col xs='1'>
                    </Col>
